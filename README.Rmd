...
article_details = function(key, open_access = FALSE, code_repo = NULL, code_doi = NULL) {
  ...
  if (!is.null(code_repo)) {
    repo = p(strong("Repository:"), a(href = paste0("https://github.com/", code_repo), code_repo))
  } else {
    repo = p(strong("Repository:"), "Not Available")
  }
  
  if (!is.null(code_doi)) {
    archive = p(strong("Archive:"), build_doi_badge(code_doi))
  } else {
    archive = p(strong("Archive:"), "Not Available")
  }
  ...
  tags$details(
    ...
    tags$ul(
      ...
      p(book_reader_img, strong(em("ABSTRACT"))),
      my_br(-0.9),
      tags$ul(
      ...
      p(code_img, strong(em("CODE/DATA"))),
      my_br(-0.9),
      tags$ul(
        repo,
        my_br(-1),
      ...
      p(comment_img, strong(em("CITATIONS"))),
      my_br(-0.9),
      tags$ul(
        p(strong("Crossref: "), bib_data$cites_crossref),
        my_br(-1),
        p(strong("Google Scholar: "), bib_data$cites_gscholar)
      )
    ),
    p()
  )
